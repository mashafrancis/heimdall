	...
	return (
		<AnimatePresence>
			{isOpen && !isMobile && (
				...
				>
					<div className=' relative flex h-max flex-col rounded-md border  bg-gradient-to-tr from-gray-50 to-gray-200 px-4  pb-6 animate-in dark:border-stone-800 dark:from-black dark:to-gray-800/20'>
						...
						<div className='group relative flex items-start gap-2'>
							...
							<div className=' bg-gradient-br relative flex h-max w-[600px] flex-col rounded-md border  from-gray-100 to-gray-300 pb-6 animate-in dark:border-stone-800 dark:from-black dark:to-gray-800/20 '>
