...
export const PLANS = [
  ...
  },
  {
    ...
    priceMonthly: '8',
    priceAnnually: '10',
    description: 'Everything on the free, plus',
    features: [
      '5 Websites',
      'Unlimited Team Member',
      '1 Million Monthly PageView',
      '500k Custom Events',
      'All Time Reporting Windows',
      'Unlimited Monthly Page Views',
      'Unlimited Data Retention',
      '50k API Requests',
      'Monthly Ingested Email',
    ],
    notIncluded: [],
  },
  {
    ...
    priceMonthly: '50',
    priceAnnually: 'Nan',
    description: 'Everything on the pro, plus',
    features: [
      '20 Website',
      'Unlimited Custom Events',
      'Unlimited API Requests',
      'Configurable Ingested Email',
    ],
    price: {
      monthly: {
        amount: 49,
